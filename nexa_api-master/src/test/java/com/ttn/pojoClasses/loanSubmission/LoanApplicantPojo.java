...
public class LoanApplicantPojo {
	    ...
	    private String channel_id;
     	...
     	@JsonProperty("loan_applicant_id")
	    private String loan_applicant_id;
     	
     	@JsonProperty("is_co_applicant_journey")
	    private String is_co_applicant_journey;

		public LoanApplicantPojo(String enquiry_id, String mobile, String title, String father_name, String gender,
				String pan, String aadhar, String gross_annual_income, String net_annual_income,
				String work_experience_years, String work_experience_months, String first_name, String middle_name,
				String last_name, String email, String dob, String residence_type, String employment_type,
				String business_name, String defence_id, String financier_id, String channel_id,
				String loan_applicant_id, String is_co_applicant_journey) {
		...
		public String getLoan_applicant_id() {
			return loan_applicant_id;
		}

		public void setLoan_applicant_id(String loan_applicant_id) {
			this.loan_applicant_id = loan_applicant_id;
		}
