 ...
 */
        ...
        public class SendCampaignOTP  {
	
	    protected static Logger logger = LoggerFactory.getLogger(SendCampaignOTP.class);
	    ...
	    private static String  endpoint = "/maruti/user/v1/maruti/campaign-otp";
	   ...
	   */   
		...
		public static void validInput(String bodyData) {
	        ...
	        logger.info("Endpoint for Send Campaign OTP API" +endpoint);
			...
			logger.info("Actual status code :"+" " +SendCampaignOTP.code);
			logger.info("Test case executed successfully");
			}
			catch(Exception e)
			{
				logger.info("Exeption While Executing Arena FMP Send Campaign OTP API with Valid Input" + e);
			}
	    }
	...
	//	 Method is used to Verify Functionality to generate/ Send Campaign OTP Functionality with Blank Mobile Number
		public static void blank_MobileNumber(String bodyData) {
			...
			{
				logger.info("Exeption While Executing Arena FMP Send Campaign  OTP API with Blank Mobile Number" + e);
			}
	    }
		...
		public static void invalid_MobileNumber(String bodyData) {
			...
			{
				logger.info("Exeption While Executing Arena FMP Send Campaign  OTP API with Invalid Mobile Number" + e);
			}
	        }
