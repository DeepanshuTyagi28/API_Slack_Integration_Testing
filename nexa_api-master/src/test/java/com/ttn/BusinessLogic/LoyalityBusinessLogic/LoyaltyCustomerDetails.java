 ...
 */
	    ...
	    protected static Logger logger = LoggerFactory.getLogger(LoyaltyCustomerDetails.class);
	    ...
	    /*
	 		 * @param bodyData
	 		 * Method is used to Verify Loyalty Customer Details with valid/Existing Loyalty Card Details 
	 	*/
