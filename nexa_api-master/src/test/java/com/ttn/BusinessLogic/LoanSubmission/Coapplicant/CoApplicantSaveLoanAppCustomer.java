 ...
 */
        ...
        public class CoApplicantSaveLoanAppCustomer  {
	
	    protected static Logger logger = LoggerFactory.getLogger(CoApplicantSaveLoanAppCustomer.class);
       ...
       //Method is used to Verify Functionality to Arena CO-Applicant Loan Submission : Save Loan APP Customer  API
		...
		public static void validInput(String bodyData) {
	        ...
	        logger.info("Endpoint for Arena CO-Applicant Loan Submission : Save Loan APP Customer  API"+" " +endpoint);
			...
			logger.info("Actual status code :"+" " +CoApplicantSaveLoanAppCustomer.code);
			logger.info("Test case executed successfully");
			}
			catch(Exception e)
			{
				logger.info("Exeption While Executing Arena CO-Applicant Loan Submission : Save Loan APP Customer  API with valid Input" + e);
			}
	    }
	       ...
	       //Method is used to Verify Functionality to Arena CO-Applicant Loan Submission : Save Loan APP Customer  API with Blank Enq ID
			...
			public static void blank_EnqID(String bodyData) {
				...
				{
					logger.info("Exeption While Executing Arena CO-Applicant Loan Submission : Save Loan APP Customer  API With Blank Enq ID" + e);
				}
		    }	
		       ...
		       //Method is used to Verify Functionality to Arena CO-Applicant Loan Submission : Save Loan APP Customer  API with Invalid Enq ID
				...
				public static void invalid_EnqID(String bodyData) {
					...
					{
						logger.info("Exeption While Executing Arena CO-Applicant Loan Submission : Save Loan APP Customer  API With Invalid Enq ID" + e);
					}
			    }			
