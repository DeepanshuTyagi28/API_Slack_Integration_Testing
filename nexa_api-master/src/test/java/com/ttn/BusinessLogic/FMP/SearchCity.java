 ...
 */
	    ...
	    protected static Logger logger = LoggerFactory.getLogger(SearchCity.class);
	    ...
	    private static String  endpoint = "/maruti/loan-offer/v1/city/search";
	    
	    
	    /*
	 		  @param bodyData
	 		  Method is used to Verify Functionality Of Arena FMP API to Search City with Valid Input
	   */
		...
		public static void ValidInput(String bodyData) {
	        ...
	        logger.info("Endpoint for Search City API" +endpoint);
			...
			logger.info("Actual status code :"+" " +SearchCity.code);
			logger.info("Test case executed successfully");
			}
			catch(Exception e)
			{
				logger.info("Exeption While Executing Arena FMP Search City API with Valid Input" + e);			}
	    }
...
//	 Method is used to Verify Functionality Of Arena FMP API to Search City with Blank Search text
		...
		public static void blank_search_text(String bodyData) {
			...
			{
				logger.info("Exeption While Executing Arena FMP Search City API with Blank Search text" + e);			}
	    }	
...
//		 Method is used to Verify Functionality Of Arena FMP API to Search City with short Length Search text Keyword(Length of 3 Words are required in order to execute test with search field)
			...
			public static void length_search_text(String bodyData) {
				...
				{
					logger.info("Exeption While Executing Arena FMP Search City API with short Length Search text Keyword" + e);			}
		    }	
...
//			 Method is used to Verify Functionality Of Arena FMP API to Search City with Blank financier_id
				...
				public static void blank_financier_id(String bodyData) {
					...
					{
						logger.info("Exeption While Executing Arena FMP Search City API with  Blank financier_id" + e);			}
			    }	
...
//				 Method is used to Verify Functionality Of Arena FMP API to Search City with Invalid financier_id
					...
					public static void invalid_Financier_Id(String bodyData) {
						...
						{
							logger.info("Exeption While Executing Arena FMP Search City API with Invalid financier_id" + e);			}
				    }	
