...
public class ValidSPGetLoyelityCustDetailsTest extends BaseLib {
	...
	@Test(groups = { "Sanity",
			"Regression","NEXA" , "Prod"}, dataProvider = "validSP_GET_LOYALITY_CUST_DETAILS_Positive_Test", dataProviderClass = DataProviderSource.class)
	...
	@Test(groups = { "Sanity",
			"Regression","NEXA" , "Prod"}, dataProvider = "invalidSP_GET_LOYALITY_CUST_DETAILS_Negative_Test", dataProviderClass = DataProviderSource.class)
