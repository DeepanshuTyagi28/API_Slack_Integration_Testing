...
import com.ttn.BusinessLogic.ArenaService.GetDealerByCity;
...
//Method is used to Verify Functionality to Arena Services : Get State Master
    public class GetDealerByCityTest extends BaseLib {

    @Test(groups = {"Sanity", "Regression" , "ARENA"})
    public void getDealerByCity_ValidInput() 
    {
    	GetDealerByCity.validInput();
        Assert.assertEquals(GetDealerByCity.code, 200,"Status Code Validation Failed for Arena Service Get Dealer By City API");
    ...
    @Test(groups = {"Sanity", "Regression" , "ARENA"})
    public void getDealerByCity_InvalidInput() 
    {
    	GetDealerByCity.invalidInput();
        Assert.assertEquals(GetDealerByCity.code, 200,"Status Code Validation Failed for Arena Service Get Dealer By City API");
    } 
    }	
