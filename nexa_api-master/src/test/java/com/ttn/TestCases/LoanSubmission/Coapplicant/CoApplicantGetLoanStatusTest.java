...
import com.ttn.BusinessLogic.LoanSubmission.Coapplicant.CoApplicantGetLoanStatus;
...
public class CoApplicantGetLoanStatusTest extends BaseLib {

    @Test(groups = {"Sanity", "Regression" , "ARENA","Prod"})
    public void coApplicant_GetLoanStatus_ValidInput()
   
    {
    	CoApplicantGetLoanStatus.validInput();
        Assert.assertEquals(CoApplicantGetLoanStatus.Status, "Success");
        Assert.assertEquals(CoApplicantGetLoanStatus.message, "Loan status successfully returned" ,"Status Validation for Arena CO-Applicant Loan Submission :Get Loan Status API");
    }  
